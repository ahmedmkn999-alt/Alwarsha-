  ...
  return (
    <Link href={`/product/${product.id}`} className="block group">
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
        ...
        {/* منطقة التفاصيل */}
        <div className="p-4">
          <h3 className="font-bold text-gray-900 line-clamp-1 mb-1 group-hover:text-orange-600 transition-colors">
            {product.name}
          </h3>
          <p className="text-xs text-gray-500 mb-4 bg-gray-100 inline-block px-2 py-1 rounded">
            موديل: {product.model || "عام"}
          </p>
          ...
          <div className="flex justify-between items-center">
            ...
            {/* زر وهمي للشكل (الضغط الفعلي بياخدك لصفحة المنتج) */}
